    ...
    .bg1
      .row.justify-content-center.align-items-start.mb-5
        ...
        .col-lg-8.my-3
          ...
          p(data-aos="fade-down").mb-4 Dado esto, las empresas deben desarrollar programas de vigilancia epidemiológica que permita disminuir, minimizar o neutralizar cualquier tipo de riesgo que pueda generar cualquier tipo de afectación.
          .cajon.color-primario.p-4.mb-4(data-aos="flip-down")
            ...
            p(data-aos="fade-down").mb-0 Se han presentado algunas actualizaciones dentro de esta ley, la siguiente fue el Decreto 1477 de 2014 y la última en el decreto 676 de 2020, donde se incluye el COVID-19 como enfermedad laboral.
      ...
      p(data-aos="fade-down").mb-5 Los grupos se crean, de acuerdo con la naturaleza de la empresa, las especificaciones del cargo y las áreas en las cuales el colaborador deberá desarrollar sus funciones. Dentro del Decreto 1477 de 2014 y la actualización realizada en el decreto 676 del 2020. A continuación, se presenta las distribuciones de enfermedades laborales:
