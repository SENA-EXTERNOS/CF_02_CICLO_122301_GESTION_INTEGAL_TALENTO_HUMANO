    ...
    .row.justify-content-center.align-items-center.mb-5           
      ...
      .col-lg-10
        .cajon.color-acento-contenido.p-4(data-aos="flip-down")
          p(data-aos="fade-down").mb-0 Después de identificar y valorar los riesgos se hace necesario dar un manejo y solución dentro de la normatividad vigente, por lo tanto, se debe considerar los siguientes métodos:  los de manejo, dependiendo de los índices de presencia de riesgos, métodos de identificación como una herramienta que permita conocer y diseñar medidas preventivas para el manejo de los riesgos laborales, autorreportes, desarrollados por el empleado y las estrategias de prevención. A continuación, encontrará los detalles de cada procedimiento mencionado.
      ...
      .py-3.py-md-4(titulo="Métodos de manejo")
        .row.justify-content-center.align-items-start.py-4
          .col-lg-8
            ...
            p 1.  Evaluación previa del puesto de trabajo, el cual se desarrolla de manera preventiva, para evitar posibles situaciones de accidentalidad en los empleados.

            p 2.  En caso de ocurrir una eventualidad, se realizan acciones correctivas que eviten una nueva ocurrencia del suceso.

            p 3.  De supervisión o mantenimiento, esto se hace para mantener un ambiente seguro en el puesto de trabajo, verificando que todos los aspectos se encuentren dentro de los rasgos de normalidad.
      ...
      .py-3.py-md-4(titulo="Métodos de identificación")
        .row.justify-content-center.align-items-start.py-4
          .col-lg-8
            ...
            p 1.  La delimitación de la zona, área o cargo, especificando características

            p 2.  El análisis del estado físico, las personas que desarrollan el cargo o la función (edad, antigüedad y género).

            p 3.  La identificación y evaluación de los riesgos laborales existentes.

            p 4.  La  especificación de aspectos del ambiente (ventilación, iluminación, estado de las paredes, pisos, etc.)

            p 5.  La descripción de las máquinas en caso de que el cargo requiera manejo de máquinas, materia prima y producto final.

            p 6.  Los turnos manejados para el cargo, si son rotativos, la jornada laboral. 
